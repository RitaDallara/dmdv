...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { content: @slide.content, next: @slide.next, number: @slide.number, previous: @slide.previous, title: @slide.title }
    end
  ...
  test "should update slide" do
    patch :update, id: @slide, slide: { content: @slide.content, next: @slide.next, number: @slide.number, previous: @slide.previous, title: @slide.title }
    assert_redirected_to slide_path(assigns(:slide))
  end
